...
public class Fragment_wed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View views = inflater.inflate(R.layout.fragment_mon, container, false);
    ...
    public void getdatas() {
        ...
        Cursor datas = mdatabase.getdata_sun("Wednesday");
    ...
    public void adddatas_routine(String starttime,String endtime,String subject,String teachername){
        mdatabase = new Database(getContext());
        boolean res = mdatabase.adddata(new Routinedata_sqlite("Wednesday",starttime,endtime,subject,teachername));
        if(res) {
